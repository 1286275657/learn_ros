...
(cl:in-package srv_client_server-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <AddInts-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddInts-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name srv_client_server-srv:<AddInts-request> is deprecated: use srv_client_server-srv:AddInts-request instead.")))

(cl:ensure-generic-function 'num1-val :lambda-list '(m))
(cl:defmethod num1-val ((m <AddInts-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader srv_client_server-srv:num1-val is deprecated.  Use srv_client_server-srv:num1 instead.")
  (num1 m))

(cl:ensure-generic-function 'num2-val :lambda-list '(m))
(cl:defmethod num2-val ((m <AddInts-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader srv_client_server-srv:num2-val is deprecated.  Use srv_client_server-srv:num2 instead.")
  (num2 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AddInts-request>)))
  ...
  "srv_client_server/AddIntsRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AddInts-request)))
  "Returns string type for a service object of type 'AddInts-request"
  "srv_client_server/AddIntsRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<AddInts-request>)))
  ...
  (cl:format cl:nil "#服务器请求时发送的两个数字~%int32 num1~%int32 num2~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'AddInts-request)))
  "Returns full string definition for message of type 'AddInts-request"
  (cl:format cl:nil "#服务器请求时发送的两个数字~%int32 num1~%int32 num2~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <AddInts-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddInts-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name srv_client_server-srv:<AddInts-response> is deprecated: use srv_client_server-srv:AddInts-response instead.")))

(cl:ensure-generic-function 'sum-val :lambda-list '(m))
(cl:defmethod sum-val ((m <AddInts-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader srv_client_server-srv:sum-val is deprecated.  Use srv_client_server-srv:sum instead.")
  (sum m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AddInts-response>)))
  ...
  "srv_client_server/AddIntsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AddInts-response)))
  "Returns string type for a service object of type 'AddInts-response"
  "srv_client_server/AddIntsResponse")
