...
"""autogenerated by genpy from srv_client_server/AddIntsRequest.msg. Do not edit."""
import codecs
import sys
...
class AddIntsRequest(genpy.Message):
  ...
  _type = "srv_client_server/AddIntsRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """#服务器请求时发送的两个数字
int32 num1
int32 num2
"""
  __slots__ = ['num1','num2']
...
def _get_struct_2i():
    ...
    return _struct_2i
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from srv_client_server/AddIntsResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class AddIntsResponse(genpy.Message):
  ...
  _type = "srv_client_server/AddIntsResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
class AddInts(object):
  _type          = 'srv_client_server/AddInts'
